        ...
        <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
          ...
          <main className="flex-grow max-w-7xl w-full mx-auto px-4 py-8">
            ...
            <div className="flex items-center gap-3 mb-6">
              <Link 
                to="/"
                className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-600 hover:text-slate-900 transition-colors shadow-sm cursor-pointer w-fit"
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  {filteredCentros.length === 0 && (
                    <button
                      ...
                      className="text-sm text-rose-600 font-semibold hover:underline cursor-pointer"
                    >
